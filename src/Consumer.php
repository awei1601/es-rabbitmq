...
class Consumer
{
     ...
     * @param string $mqType //交换器类型
     * @param string $queueName
     * @return $this
     */
    public function setConfig($exchange, $routingKey, $mqType = 'direct', $queueName = ''): Consumer
    {
    ...
    function listen(callable $call, float $breakTime = 0.01, float $waitTime = 0.1, int $maxCurrency = 128)
    {
        ...
        $this->driver->consumerPop($call,$this->job);  // 这边本身自己会挂起
    }
